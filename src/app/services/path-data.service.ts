...
export class PathDataService {
  ...
  getCourseDataV2(id:string) {
    return this.http.get(this.url + '/paths/' + id + '?projection=course')
  }
  getOngoingPathsData() {
    return this.ongoingPaths.data.enrolledPaths;
  }
  getOngoingPathsDataV2(id : string) {
    return this.http.get(this.url + '/enrolled-paths')
  }
  getDataV2() {
